			...
			<div class="footer_nav" style="width: 630px;" align="center">
				<div class="footer_nav_sub" style="font-size: small; padding-top: 20px; padding-left: 40px;">
					<ul>
						...
						<li><a href="#" style="text-decoration: none; color: black;">찾아오시는 길</a> |</li>
						<li><a href="#" style="text-decoration: none; color: black;">사이트맵</a> |</li>
					</ul>
				</div>
				<div class="footer_nav_sub ft_copyright" style="padding-top: 15px; padding-left: 40px;">서울 마포구 월드컵북로 21 2층 풍성빌딩 | 고객센터 : 1234 - 1234 | Copyright ©
					2020 Doomfood Corporation. All Right Reserved</div>
			</div>
			<div class="footer_nav" style="width: 200px; float: right;">
				<div id="familysitediv">

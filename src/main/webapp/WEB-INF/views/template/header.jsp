					...
					<div class="collapse navbar-collapse" id="myNavbar">
						<ul class="nav navbar-nav">
							...
							<li>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
								&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</li>
							<!-- 영호 추가 -->
							<!--<li><a><input type=button value="나의 신청 현황" onclick="javascript:openWin();"></a></li> 영호 추가 -->
							<li>
								<form class="form-inline" style="padding-top: 6.5px;"
									...
									</select> <input type="text" class="form-control" size="60%"
										placeholder="맛집을 검색하세요!" style="margin: 0px auto;"
										name="search">
						...
						<ul class="nav navbar-nav navbar-right">
							<c:if test="${empty member and empty sessionId}">
								...
								<li>
									...
									</div> <!-- <a href="${pageContext.request.contextPath}/member/memberJoin"><span class="glyphicon glyphicon-user"></span>회원 가입</a>-->
								</li>
								...
								<li>
									...
									</div> <!-- <a href="${pageContext.request.contextPath}/member/memberLogin"><span class="glyphicon glyphicon-user"></span>로그인</a>-->
								</li>
							</c:if>

							<c:if test="${not empty member}">

								<!-- <li><a href="" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user dro"></span>회원 정보<b class="caret"></b></a></li>
								...
								<c:if test="${member.id eq 'admin'}">
									<li>
										<div style="margin-top: 8px;" class="dropdown">
											...
											<ul class="dropdown-menu">
												<li><a
													href="${pageContext.request.contextPath}/member/memberList">회원정보관리</a></li>
												<li class="divider"></li>
